...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/vivado_project/vivado_project.srcs/utils_1/imports/synth_1/LED_Project.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/src/rtl/LED_Project.v"]"\
...
set_property -name "top" -value "LED_Project" -objects $obj
...
set file "synth_1/LED_Project.dcp"
...
set_property -name "incremental_checkpoint" -value "$proj_dir/vivado_project.srcs/utils_1/imports/synth_1/LED_Project.dcp" -objects $obj
